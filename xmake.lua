...
target("PixL-Studio")
    ...
    add_files("libs/PixL-Rendering-Engine/src/**.cpp")
    add_includedirs("libs/PixL-Pak/include")
    add_includedirs("libs/PixL-Studio/include")
    add_files("libs/PixL-Studio/src/**.cpp")
    add_includedirs("include")
    add_files("src/**.cpp")
    add_packages("libsdl3", "libsdl3_image", "glm" , "imgui", "nlohmann_json")
